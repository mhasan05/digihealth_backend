...
DATABASES = {
    'default': {
        ...
        # (This is a plain sqlite3.connect() parameter — safe on every host,
        # unlike a persistent PRAGMA such as journal_mode.)
        'OPTIONS': {'timeout': 20},
    }
}
